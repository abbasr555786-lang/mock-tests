...
(function () {
  ...
  */
  ...
  function ensureSidebar() {
    ...
    aside.innerHTML =
      ...
      '<nav class="sidebar__nav" aria-label="Featured exams">' +
        ...
        '<a class="sidebar__link sidebar__link--exam" data-nav="exam:jmi-ba-english" href="#/exam/jmi-ba-english"><span class="sidebar__tag sidebar__tag--ssc" aria-hidden="true">JMI</span><span>JMI BA English</span></a>' +
        '<a class="sidebar__link sidebar__link--exam" data-nav="exam:jmi-ba-polsci" href="#/exam/jmi-ba-polsci"><span class="sidebar__tag sidebar__tag--ssc" aria-hidden="true">JMI</span><span>JMI BA Political Science</span></a>' +
  ...
  const FEATURED_EXAM_IDS = ['jmi-mba', 'jmi-ballb', 'jmi-bcom-bba', 'jmi-ba-english', 'jmi-ba-polsci', 'jmi-bsc', 'jmi-mca', 'jmi-class9', 'jmi-class11-science', 'jmi-rca', 'jmi-phd', 'jmi-massmedia-hindi']; // JamiaPrep: JMI-only. Was ['jmi-mba','ssc-cgl','neet-ug'].
  const FEATURED_BADGE = { 'jmi-mba': 'JMI', 'jmi-ballb': 'JMI', 'jmi-ba-english': 'JMI', 'jmi-ba-polsci': 'JMI', 'jmi-bcom-bba': 'JMI', 'jmi-bsc': 'JMI', 'jmi-mca': 'JMI', 'jmi-class9': 'JMI', 'jmi-class11-science': 'JMI', 'jmi-rca': 'JMI', 'jmi-phd': 'JMI', 'jmi-massmedia-hindi': 'JMI', 'ssc-cgl': 'SSC', 'neet-ug': 'NEET' };
  ...
  const TARGET_EXAMS = [
    ...
    { id: 'jmi-ba-english', label: 'JMI BA English' },
    { id: 'jmi-ba-polsci', label: 'JMI BA Political Science' },
